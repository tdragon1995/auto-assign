...
/**
 * Lat/long pair road-distance checker (the original /distance-checking tool),
 * extracted into a panel so it can live both on its standalone route and inside
 * the dashboard "Distance checking" tab. Layout-agnostic — the caller wraps it.
 */
export function DistanceCheckingPanel() {
    ...
    <div className="p-3 sm:p-4">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            <h2 className="text-lg font-bold">Kiểm tra khoảng cách</h2>
